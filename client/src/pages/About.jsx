  ...
  return (
    <>
      <Seo
        ...
        description="Kapilesh is a Learning & Development (L&D) consultant, organisational capability leader and leadership mentor based in Noida, India, with 34+ years of experience across leadership, sales, learning and transformation."
        path="/about"
        jsonLd={jsonLd}
      />
